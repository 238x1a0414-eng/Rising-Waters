...
The system is deployed using **Flask FrameWork**.
...
---
## Our Web Application:- https://sites.google.com/view/pre-flood-prediction/home
---
...
```bash
git clone https://github.com/238x1a0414-eng/Rising-Waters.git
cd Rising-Waters
```
